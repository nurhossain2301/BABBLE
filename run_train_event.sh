...
# TRAIN_JSON=$DATA_PATH/train_snr_10_mix_8_5s_with_prompt_and_caption.json
...
# VAL_JSON=$DATA_PATH/test_snr_10_mix_8_5s_with_prompt_and_caption.json
# TEST_JSON=$DATA_PATH/test_snr_10_mix_8_5s_with_prompt_and_caption.json

# Define your paths and parameters here
MODE="event" # choices from ["event", "frame", "frame_spk_emb"] 
FRAME_SIZE=2 # choices from [0.1, 2.0], for frame-based training only 
