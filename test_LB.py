...
def main():
    ...
    parser.add_argument("--audio_encoder_name2", type=str, default="wav2vec-LL4300", choices=["wav2vec-LL4300", "openai/whisper-large-v2"], required=True, help="Path to audio model checkpoint")
    ...
    # target_length= 0.1
    # def extracted_output_array(input_string, flag=0):
    #     print(input_string)
    #     try:
    #         segments = input_string.split(",")[:int(target_length*10)] 
    #     except:
    #         try:
    #             segments = input_string[0].split(",")[:int(target_length*10)] 
    #         except:
    #             try:
    #                 segments = input_string[0].split(",")[:int(target_length*10)] 
    #             except:
    #                 segments=''
    #     out_array=[""]*int(target_length*10)
    ...
    # def extract_prediction_values(input_string, flag=0):
