...
def main():
    ...
    parser.add_argument("--audio_model_path", type=str, required=True, help="Path to audio model checkpoint")
    ...
    trainer.fit(model, train_loader, val_loader, ckpt_path = "/work/hdd/bebr/PRJ_LLM_SP25/LittleBeats-LLM/saved_model/checkpoints/merge_1b_frame_10s_3rd_stage_v29_.ckpt")
