#!/bin/bash
#SBATCH --job-name="train_caption_merge"
...
TRAIN_JSON="/work/hdd/bebr/PRJ_LLM_SP25/LittleBeats-LLM/json_event_based/train_snr_10_mix_8_5s.json"
VAL_JSON="/work/hdd/bebr/PRJ_LLM_SP25/LittleBeats-LLM/json_event_based/test_snr_10_mix_8_5s.json"
TEST_JSON="/work/hdd/bebr/PRJ_LLM_SP25/LittleBeats-LLM/json_event_based/test_snr_10_mix_8_5s.json"

# TRAIN_JSON="/work/hdd/bebr/PRJ_LLM_SP25/LittleBeats-LLM/caption_data/train_snr_10_mix_8_5s_with_prompt_and_caption.json"
# VAL_JSON="/work/hdd/bebr/PRJ_LLM_SP25/LittleBeats-LLM/caption_data/test_snr_10_mix_8_5s_with_prompt_and_caption.json"
# TEST_JSON="/work/hdd/bebr/PRJ_LLM_SP25/LittleBeats-LLM/caption_data/test_snr_10_mix_8_5s_with_prompt_and_caption.json"
